...
extern "C" void _hybris___cfi_fail(uint64_t CallSiteTypeId, void* Ptr, void *DiagData, void *CallerPc);

static void __loader_cfi_fail(uint64_t CallSiteTypeId, void* Ptr, void *DiagData, void *CallerPc) {
    _hybris___cfi_fail(CallSiteTypeId, Ptr, DiagData, CallerPc);
}

// end hybris additions

#include "private/CFIShadow.h"

// begin hybris removal
